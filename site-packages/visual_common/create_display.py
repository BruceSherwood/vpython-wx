...
# Mouse state, including ctrl/alt etc. http://wxpython.org/docs/api/wx.MouseState-class.html
    ...
    def _OnCharEvent(self, evt):
        ...
        print(key, k, shift)
        #cvisual.display_kernel.keys.push(k)
        evt.Skip()

###########################################################################################
# https://code.google.com/p/pyglet/source/browse/pyglet/gl/lib_wgl.py
    def _getProcAddress(self, name):
        import ctypes
        if (_plat == 'Windows'):
            ptr = ctypes.windll.opengl32.wglGetProcAddress(name)
...
_plat = _plat.GetOperatingSystemFamilyName() # Windows

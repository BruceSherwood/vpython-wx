...
class window():
    def __init__(self, menus=False, _make_panel=True, x=0, y=0, width=600, height=600, title='VPython'):
        ...
        if _plat == 'Unix': height -= 27 # correction for Xubuntu and Ubuntu; not understood
    ...
    def _OnMove(self, evt):
        if _plat == 'Unix': return # Ubuntu doesn't need this move code (and misbehaves with it)
        c = self._canvas
        if c is not None:

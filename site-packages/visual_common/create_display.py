...
class window(_wx.Frame):
    def __init__(self, x=0, y=0, width=600, height=600, title='VPython'):
...
##        self._height = self.height
    ...
    def _make_canvas(self):
        ...
        glcanvas.GLCanvas.__init__(self, self.window.panel, -1, pos=(self._x, self._y),
    ...
    def _create(self):
        ...
        if self.window is None:
            self.window = window(x=self._x, y=self._y, width=self._width, height=self._height, title=self.title)

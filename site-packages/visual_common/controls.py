...
class controls: # make a special window for buttons, sliders, and pull-down menus
    def __init__(self, x=0, y=0, width=300, height=320, range=100,
        ...
        self.display.bind("mousedown", checkControlsMouse)
        self.display.bind("mousemove", checkControlsMouse)
        self.display.bind("mouseup", checkControlsMouse)

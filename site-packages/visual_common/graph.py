...
class gdisplay:
    ...
    def resize(self, x, y):
        ...
        if not self.active:
            ...
            self.display.bind("mousedown", checkGraphMouse)
            self.display.bind("mousemove", checkGraphMouse)
            self.display.bind("mouseup", checkGraphMouse)

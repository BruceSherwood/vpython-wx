...
def text_to_bitmap(text, color=(1,1,1), background=(0,0,0), opacity=1,
    ...
    if version_info[0] == 2:
        ...
        bmp = _wx.Bitmap(maxwidth,totalheight) # Phoenix version
    dc.SelectObject(bmp)
    ...
    if version_info[0] == 2:
        ...
        img = bmp.ConvertToImage() # Phoenix version
        data = fromstring(asarray(img.GetData()), dtype=uint8) # Phoenix version

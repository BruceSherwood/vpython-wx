    ...
    def GetExtraHelpSourceList(self,configSet):
        ...
        for option in options:
            ...
            if value.find(';')==-1: #malformed config entry with no ';'
                ...
                if platform().lower().split('-')[0] == 'darwin':
                    #
                    # sys.argv will be something like: argv: ['/Applications/VPython-Py2.7/VIDLE.app/Contents/Resources/idle.py']
                    #
                    appPath = sys.argv[0].split('/')[:-4] + ['docs','index.html']
                    helpPath = 'file:///' + '/'.join(appPath)
                    
                    print "new help path!", helpPath

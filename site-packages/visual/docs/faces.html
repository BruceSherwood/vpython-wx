...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;          t2v0, t2v1, 
        ...
        <p class="Normal">The <font color="#FF0000">pos</font>, <font color="#FF0000">color</font>, and <font color="#FF0000">normal</font> attributes can be specified either as Python lists or as numpy arrays. In either case, these attributes are stored as numpy arrays, which makes possible fast manipulations of these attributes. For examples of the use of numpy arrays, see the documentation of the <a href="curve.html"><strong>curve object</strong></a>, whose <font color="#FF0000">pos</font> attribute is  a numpy array.</p>
...
f.append(pos=(x,y,z), normal=(nx,ny,nz), <br />
 &nbsp;&nbsp;&nbsp;&nbsp;         red=r, green=g, blue=b)</p>
        ...
        <p class="Normal">The faces object is intended to help with writing model importers and other 
          ...
          It is considerably lower-level than any of the other objects in VPython (although 

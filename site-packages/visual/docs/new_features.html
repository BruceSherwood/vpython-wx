...
<h3 class="style1"><a name="log" id="log"></a>A log of developments since the start of VPython 5</h3>
      <p class="Normal">Here is a log of changes to VPython since the initial release of  VPython 5.0 (Visual 5.0) in December of 2008. This and earlier history can be found at <a href="http://vpython.org" target="_blank"><strong>vpython.org</strong></a> in the &quot;Recent developments&quot; section.</p>

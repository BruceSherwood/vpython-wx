...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <p class="Normal">At times you may need to know how large is the display region inside a window: <strong>window.dw</strong> and <strong>window.dh</strong> are the extra width and height of  windows compared to the display region. For example, if scene.width and scene.height are 500, the actual display region within the window has width = scene.width - window.dw and height = scene.height - window.dh.</p>

...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <p class="Normal">VPython  was initially created by David Scherer in the spring of 2000.</p>
      ...
      <p class="Normal"> Previous to VPython 4beta, Jonathan Brandmeyer made several major contributions

        ...
        <tr>
          <td width="37%"><div align="center">
            <h1><font color="#0000A0">Controls:
              buttons, sliders, menus, etc</font></h1>
          </div></td>
          <td width="63%"><a href="controls.html"><img src="images/widgets.jpg" alt="controls" width="534" height="268" /></a><a href="arrow.html"></a></td>
        </tr>
      </table>
      <div></div>
      <div class="Normal">
...
<p class="program">w = window(x=0, y=0, width=430, height=450, title=&quot;VPython&quot;)<br />
  display(window=w, .....)
</p>
        <p class="Normal">This embedded 3D display behaves exactly as any other VPython display, such as the default display &quot;scene&quot;. As usual, if you move the mouse into the 3D display portion of the window, you can rotate and zoom the camera.</p>
        <p class="Normal">To facilitate adding wxPython widgets to the window, the <strong>window</strong> and <strong>display</strong> objects provide references to the display region of the window. If as above the window is named <strong>w</strong>, the display region is referred to as <strong>w.panel</strong>. Also, <strong>w.win</strong> is the wxPython &quot;frame&quot; that constitutes the window, and <strong>w.menubar</strong> is the wxPython menubar to which you can add pull-down menus. For convenience you can also reference these objects from a <strong>display</strong> named <strong>d</strong>: <strong>d.win</strong>, <strong>d.panel</strong>, and <strong>d.menubar</strong>. At times you may need to know how large is the display region inside a window: <strong>window.dw</strong> and <strong>window.dh</strong> (not w.dw or w.dh) are the extra width and height of  windows compared to the display region. See <span class="attribute">widgets.py</span> for examples of the use of these references.</p>
        <p class="Normal">&nbsp;</p>
        <p class="Normal">&nbsp;</p>

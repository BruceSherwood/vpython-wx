...
<p class="program">w = window(menus=True, title=&quot;Widgets&quot;,<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  x=0, y=0, width=600, height=600)<br />
  display(window=w, x=50, y=30, width=200, height=150)
        ...
        <p class="Normal">To facilitate adding wxPython widgets to the window, the <strong>window</strong> and <strong>display</strong> objects provide references to the display region of the window. If as above the window is named <strong>w</strong>, the display region is referred to as <strong>w.panel</strong>. Also, <strong>w.win</strong> is the wxPython &quot;frame&quot; that constitutes the window, and <strong>w.menubar</strong> is the wxPython menubar to which you can add pull-down menus. For convenience you can also reference these objects from a <strong>display</strong> named <strong>d</strong>: <strong>d.win</strong>, <strong>d.panel</strong>, and <strong>d.menubar</strong>. At times you may need to know how large is the display region inside a window: <strong>window.dw</strong> and <strong>window.dh</strong> (not w.dw or w.dh) are the extra width and height of  windows compared to the display region. If there is a menu bar, the extra height is <strong>window.dh+window.mh</strong>. See <span class="attribute">widgets.py</span> for examples of the use of these references.</p>

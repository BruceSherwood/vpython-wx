...
scene.waitfor('click keydown') # click or keyboard <br />
        ...
        <p class="Normal">Here is a simple example of how to use callbacks to process keyboard events:</p>
        <p class="Normal">&nbsp;</p>
        <p class="Normal">&nbsp;</p>
...
<p class="Normal">Here is a test routine that lets you type text into a label. If<span class="attribute"> scene.kb.keys</span> is nonzero, 

...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <div>
        ...
        <div>
          <p class="program">spring = helix(pos=(0,2,1), axis=(5,0,0), radius=0.5)</p>
          <p class="Normal"> The helix object has the following attributes and
            default values: <span class="attribute">pos<font color="#000000"> (0,0,0)</font></span>, <span class="attribute">x</span><span
 ...
 class="attribute">radius<font color="#000000"> </font></span>(1), <span
 class="attribute">coils </span>(5), <span class="attribute">thickness </span>(radius/20), <span class="attribute">color<font color="#000000"> (1,1,1)
            which is color.white</font></span>, <span class="attribute">red<font
 color="#000000"> (1)</font></span>, <span class="attribute">green<font
 color="#000000"> (1)</font></span>, <span class="attribute">blue<font
 color="#000000"> (1)</font></span>, <a href="materials.html">material</a>, and <span class="attribute">up<font
 color="#000000"> (0,1,0)</font></span>.&nbsp;</p>
          <p class="Normal">At present, setting just the x, y, or z component of the axis of a helix does not update its appearance; it is necessary to assign a complete vector to the axis of the helix.</p>
      <p class="Normal">Note that the <span class="attribute">pos</span> attribute for cylinder, arrow, cone, pyramid, and helix corresponds to
          ...
          of a helix object, which is based on the curve object.</p>

...
<table width="800" border="0" cellpadding="1" cellspacing="0">
  ...
  <tr>
    ...
    <td width="173" valign="top" bgcolor="#DDDDDD"><p class="Normal"><a href="../index.html">Home</a></p>
      ...
      and VPython: <a href="../visual/VisualIntro.html">Introduction</a></p>
      <p class="Normal">A VPython <a href="../visual/VPython_Intro.pdf" target="_blank">tutorial</a></p>
      <p class="Normal"><a href="../visual/primitives.html">Pictures</a> of 3D objects</p>
...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <p class="Normal">What's new in <a href="../visual/new_features.html">VPython 6</a></p>
    <p class="Normal"><a href="http://vpython.org" target="_blank">VPython web site</a><br />
      <a href="../visual/license.txt" target="_blank">Visual license</a><br />
...
<script type="text/javascript" language="javascript" src="../visual/navigation.js"></script>
</html>

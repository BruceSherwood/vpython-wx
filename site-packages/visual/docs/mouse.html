...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
        ...
        <p class="program">scene.mouse.getclick()</p>
      ...
      <p class="Normal">Whether using the older or newer scheme, after the user has clicked the mouse in the <span class="attribute">scene</span> window to proceed, you can find out where the user clicked, and use that information. Here, when the user has clicked, we display a sphere at that location:</p>
        <p class="program">loc = scene.mouse.pos<br />

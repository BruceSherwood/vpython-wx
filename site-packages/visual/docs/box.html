...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <div>
        ...
        <div>
          <p class="program"> mybox = box(pos=(x0,y0,z0),<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;          length=L, height=H, width=W) </p>
        ...
        <div>
          ...
          <p class="Normal"> There remains the issue of how to orient the box rotationally 
            around the specified axis. The rule that VPython uses is to orient the width 
        ...
        <div>
          ...
          <p class="attributes"> <span class="attribute">size</span> (length, height, 
            ...
            width=12</p>
          <p class="attributes"> <span class="attribute">axis</span> After creating a box, setting the axis makes the length of the box be equal to the magnitude of the axis vector</p>

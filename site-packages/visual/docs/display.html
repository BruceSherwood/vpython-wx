...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <p class="Normal"> Initially, there is one VPython display window named <span class="attribute">scene</span>. 
        ...
        <p class="attributes"> <span class="attribute">display()</span> Creates a display 
          ...
          it. For example, the following creates another VPython display window 600 by 
      ...
      <p class="attributes"><span class="attribute">lights</span> List of light
          ...
          <p class="attributes"><span class="attribute">cursor.visible</span> By
            ...
            = True</span>.  If <span class="attribute">scene</span> is part of a wxPython window that includes other elements such as buttons, and you want to hide the cursor everywhere in a window<span class="Normal"> named </span><span class="attribute">w</span><span class="Normal">, use </span><span class="attribute">w.cursor.visible = False</span><span class="Normal">.</span></p>
...
smooth updating.</p>
      ...
      <p class="Normal"><strong><font color="#0000A0">Controlling the window</font></strong></p>
          ...
          <p class="attributes"><span class="attribute">fullscreen</span> Full screen 
            ...
            quitting the program.) If <span class="attribute">scene2</span> is part of a wxPython window that includes other elements such as buttons, <span class="attribute">scene2.fullscreen
            = True </span><span class="Normal">gives an error; if the window is named </span><span class="attribute">w</span><span class="Normal">, use </span><span class="attribute">w.fullscreen = True</span><span class="Normal">.</span></p>
      ...
      <p class="Normal">To exit a VPython program under program control, execute this:</p>

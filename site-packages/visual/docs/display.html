...
<p class="attributes"><span class="attribute">window</span> You can create a wxPython window with <strong><span class="Normal">w = window(....)</span></strong> and place various widgets in it such as <a href="controls.html"><strong>buttons and sliders</strong></a>, and VPython 3D graphics displays or graphs, like this:<strong>d = display(window=w, ....) </strong>or <strong>g = gdisplay(window=w, ....)</strong>. You have to specify a wxPython window when you create the VPython display or gdisplay; you can't create a display and then later choose to assign <strong>d.window = w</strong>. The <a href="controls.html"><strong>buttons and sliders</strong></a> description includes details on the attributes of a wxPython window object.</p>

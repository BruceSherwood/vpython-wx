...
<p class="Normal">          The program extrusion_overview.py offers an interactive tutorial on the main features of the extrusion object. Here is a <a href="extrusion_overview.py" target="_blank"><strong>copy</strong></a> of that program.</p>
...
<p class="Normal"><strong><font color="#0000a0"><a name="dynamic" id="dynamic"></a>Dynamic change of attributes</font></strong></p>
            <p class="Normal">You can dynamically change all of the attributes, even the shape. The extrusion object is rendered quite rapidly, so unusual effects are possible, as is demonstrated in the example program <a href="extrusion_overview.py">extrusion_overview.py</a> mentioned earlier.</p>

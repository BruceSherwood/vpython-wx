...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      <table width="100%" border="1">
        <tr>
          <td width="77%"><div align="center"><span class="style1 style2"><font color="#0000A0">cone</font></span></div></td>
          <td width="23%"><div align="center"><img src="images/cone.jpg" alt="cone" width="131" height="127" /><a href="arrow.html"></a></div></td>
        </tr>
      </table>
      <div></div>
      <div>
        <p class="Normal"> <img src="VisualRef-3.gif" alt="cone" align="right" /> The cone object 
          has a circular cross section and tapers to a point. The following statement 
          will display a cone with the center of its circular base at (5,2,0), pointing 
          parallel to the x axis with length 12; the wide end of the cone has radius 
          1:</p>
        <div>
          <p class="program"> cone(pos=(5,2,0), axis=(12,0,0),<br />
&nbsp;&nbsp;&nbsp;&nbsp;          radius=1)</p>
          <p class="Normal"> The cone object has the following attributes and
            default  values, like those for cylinders: <span class="attribute">pos<font color="#000000"> (0,0,0)</font></span>, <span class="attribute">x</span><span class="attribute"><font color="#000000"> (0)</font></span>, <span class="attribute">y<font color="#000000">(0)</font></span>, <span class="attribute">z<font color="#000000">(0)</font></span>, <span class="attribute">axis<font color="#000000"> (1,0,0)</font></span>, <span class="attribute">length<font color="#000000"> (1)</font></span>, <span class="attribute">color<font color="#000000"> (1,1,1)
             ...
             and <span class="attribute">up<font color="#000000"> (0,1,0)</font></span>.
              As with cylinders, <span class="attribute">up</span> has only a
              subtle effect on the 3D appearance of a cone unless a non-smooth
              material is specified. Additional cone attribute:</p>
          <p class="attributes"> <span class="attribute">radius</span> Radius of the 
            wide end of the cone, default = 1</p>
        </div>
      </div>
      <div>

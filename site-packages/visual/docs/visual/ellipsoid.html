    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      <div>
        <table width="100%" border="1">
          <tr>
            <td width="77%"><div align="center"><span class="style1 style2"><font color="#0000A0">ellipsoid</font></span></div></td>
            <td width="23%"><div align="center"><img src="images/ellipsoid.jpg" alt="ellipsoid" width="130" height="127" /><a href="arrow.html"></a></div></td>
          </tr>
        </table>
        </div>
      <div>
        <p class="Normal"> A long ellipsoid object looks like a cigar; a short one looks 
          like somewhat like a pill. Its cross sections are circles or ellipses. The 
          elllipsoid object has the same attributes as the <a href="box.html">box object</a> and it can be thought of as fitting inside a box of the same dimensions:</p>
        <div>
          <p class="program"> myell = ellipsoid(pos=(x0,y0,z0), <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            length=L, height=H, 
            width=W) </p>
          <p class="Normal"> The given position is in the center of the ellipsoid, at 
            ...
            vector components of the ellipsoid as<span class="attribute"> myell.x</span>, <span class="attribute">myell.y</span>, and <span class="attribute">myell.z</span>. 
            ...
            we have <span class="attribute">myell.axis = (L, 0, 0)</span> . Note that 
            the axis of an ellipsoid is just like the axis of a cylinder. </p>
          <p class="Normal"> For an ellipsoid that isn't aligned with the coordinate 
            ...
            on the <a href="box.html">box object</a>):</p>
        </div>
        <div>
          <p class="program"> myell = ellipsoid(pos=(x0,y0,z0), axis=(a,b,c), <br />
&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;length=L, height=H, width=W) </p>
          <p class="Normal"> The axis attribute gives a direction for the length of 
            ...
            magnitude of the axis vector). </p>
          <p class="Normal"> The ellipsoid object has the following attributes and default 
            values, like those for cylinders: <span class="attribute">pos<font color="#000000"> (0,0,0)</font></span>, <span class="attribute">x</span><span class="attribute"><font color="#000000"> (0)</font></span>, <span class="attribute">y<font color="#000000">(0)</font></span>, <span class="attribute">z<font color="#000000">(0)</font></span>, <span class="attribute">axis<font color="#000000"> (1,0,0)</font></span>, <span class="attribute">length<font color="#000000"> (1)</font></span>, <span class="attribute">color<font color="#000000"> (1,1,1) 
              which is color.white</font></span>, <span class="attribute">red<font color="#000000"> (1)</font></span>, <span class="attribute">green<font color="#000000"> (1)</font></span>, <span class="attribute">blue<font color="#000000"> (1)</font></span>, <span class="attribute">opacity</span> (1), <a href="materials.html">material</a>, and <span class="attribute">up<font color="#000000"> (0,1,0)</font></span>. 
            Additional  attributes, similar to those for a box:</p>
        </div>
        <div>
          ...
          <p class="attributes"> <span class="attribute">size</span> (length, height, 
            ...
            <span class="attribute"> myell.size=(20,10,12) </span>sets length=20, height=10, 
            width=12</p>

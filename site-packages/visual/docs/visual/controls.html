...
<p class="program">w = window(x=0, y=0, width=430, height=450, title=&quot;VPython&quot;)<br />
  display(window=w, .....)
        ...
        <p class="Normal">To facilitate adding wxPython widgets to the window, the <strong>window</strong> object provides references to the display region of the window. If as above the window is named <strong>w</strong>, the display region is referred to as <strong>w.panel</strong>. Also, <strong>w.win</strong> is the wxPython &quot;frame&quot; that constitutes the window, and <strong>w.menubar</strong> is the wxPython menubar to which you can add pull-down menus. At times you may need to know how large is the display region inside a window: <strong>window.dw</strong> and <strong>window.dh</strong> (not w.dw or w.dh) are the extra width and height of  windows compared to the display region. See <span class="attribute">widgets.py</span> for examples of the use of these references.</p>
        <p class="Normal">&nbsp;</p>
        <p class="Normal">&nbsp;</p>

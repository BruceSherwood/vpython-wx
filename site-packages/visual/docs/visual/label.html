...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
          ...
          <p class="Normal"> With the label object you can display 2D text in
            a box, and the label always faces forward, even if you rotate the
            scene (for 3D text, see the <a href="text.html"><strong>text</strong></a> object). Here are simple examples
            (in the second label statement, note the standard Python scheme for
            formatting numerical values, where 1.5f means 1 figure before the
</p>
...
&nbsp;&nbsp;&nbsp; font='sans')</p>
      ...
      <p class="attributes"> <span class="attribute">text</span> The text to be 
            ...
            <p class="attributes"> <span class="attribute">color</span>, <span class="attribute">red</span>, <span class="attribute">green</span>, <span class="attribute">blue</span> Color of the text; default is scene.foreground</p>

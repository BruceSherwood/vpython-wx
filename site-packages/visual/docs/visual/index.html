...
<table width="800" border="0" cellpadding="0" cellspacing="0">
 ...
 color="#ff0000">The Visual Module of VPython</font></span>          </div>
      ...
      <p class="Normal">The new version makes an essential change to the syntax of VPython programs. Now, an animation loop <strong><em>MUST</em></strong> contain a <span class="attribute">rate</span> or <span class="attribute">sleep</span> statement, which limits the number of loop iterations per second as before but also when appropriate (about 30 times per second) updates the 3D scene and handles mouse and keyboard events. Without a <span class="attribute">rate</span> or <span class="attribute">sleep</span> statement, the scene will not be updated until and unless the loop is completed.</p>
      <p class="Normal">You should use the new function <span class="attribute">sleep</span> rather than time.sleep. The new function periodically renders the scene and processes mouse events, making it possible to continue using zoom and rotate, whereas time.sleep does not do this.</p>

...
<p class="Normal"> Here are the curve attributes:</p>
 ...
 class="attribute">append()</span> function. A new point by default
          ...
          <p class="Normal">In the image shown here, the upper thick curve, made without the optional blue point, has three pos and color points, blue, orange, orange, left to right, so the blue fades into the orange. The lower curve includes the optional blue point and has four pos and color points, blue, blue, orange, orange, so there is a sharp break between blue and orange.</p>

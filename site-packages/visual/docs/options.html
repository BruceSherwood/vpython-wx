    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <p class="attributes"><span class="attribute">frame</span> Place this object 
        ...
        <p class="attributes"> <span class="attribute">display</span> When you start 
          ...
          a VPython program, for convenience VPython creates a display window and names 
          ...
          like this: </p>
        <p class="attributes"> <span class="attribute">make_trail</span> You can specify that a trail be left behind a moving arrow, box, cone, cylinder, ellipsoid, pyramid, ring, or sphere object. For details, see <strong><a href="trail.html">Leaving a Trail</a></strong>.</p>
          ...
          <p class="Normal">There is a <a href="rotation.html">rotate function</a> for
            all objects other than the &quot;array objects&quot; curve, convex, extrusion, faces, text, and points (which can
      ...
      <p class="Normal">Here is an example that uses the <span class="attribute">__copy__()</span> function.
        The following routine  copies all of the VPython objects currently existing
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            frame=frames[obj.frame])<br />
        ...
        <p class="Normal">See <a href="display.html">Controlling One or More VPython 

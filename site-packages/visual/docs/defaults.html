...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <div>
        <p class="Normal"> Objects can be specified with convenient defaults:</p>
        <p class="Normal"> arrow() is equivalent to arrow(pos=(0,0,0), axis=(1,0,0), radius=1)</p>
        ...
        <p class="Normal"> convex() establishes an &quot;empty&quot; object to
          which points can be appended</p>
        <p class="Normal"> curve() establishes an &quot;empty&quot; curve to
          which points can be appended</p>
        <p class="Normal"> cylinder() is equivalent to cylinder(pos=(0,0,0),
          axis=(1,0,0), radius=1)</p>
        <p class="Normal"> ellipsoid() is equivalent to ellipsoid(pos=(0,0,0),
          size=(1,1,1))</p>
        <p class="Normal"> frame() establishes a frame with pos=(0,0,0) and axis=(1,0,0)</p>
        <p class="Normal"> helix() is equivalent to helix(pos=(0,0,0),
          axis=(1,0,0), radius=1, thickness=0.05, coils=5)</p>
        <p class="Normal"> points() establishes an &quot;empty&quot; set of points
          to which points can be appended</p>
        <p class="Normal">pyramid() is equivalent to pyramid(pos=(0,0,0), size=(1,1,1), 
          axis=(1,0,0))</p>
        <p class="Normal"> ring() is equivalent to ring(pos=(0,0,0), axis=(1,0,0),
          radius=1)</p>
        <p class="Normal"> sphere() is equivalent to sphere(pos=(0,0,0), radius=1 )</p>
      </div>
      <div> </div>

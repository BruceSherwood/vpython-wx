      ...
      <div>
        ...
        <div>
          ...
          <p class="Normal">This default behavior makes the widths of very short
            ...
            change as the arrow gets  very short or very long, specify the desired <span class="attribute">shaftwidth</span>, which also sets <span class="attribute">fixedwidth
            = True</span>. 
            ...
            flat head. (You can later set  <span class="attribute">fixedwidth
            = False</span> , but the effect your get is not particularly useful. It used to be that setting <span class="attribute">shaftwidth</span> required also setting <span class="attribute">fixedwidth</span> in order to get sensible results, but starting with VPython 6.10 it is sufficient just to set <span class="attribute">shaftwidth</span> to the desired value.)</p>

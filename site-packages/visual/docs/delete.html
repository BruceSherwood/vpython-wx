...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <div>
        <p class="Normal"> To hide a Visual object just make it invisible: <span class="attribute">ball.visible 
        ...
        <p class="Normal">If however you later re-use the name <span class="attribute">ball</span>, 
          ...
          Python will be free to release the memory used by the object formerly named <span class="attribute">ball</span> (assuming no other names currently refer 
        ...
        <p class="Normal">After you make an object named ball invisible, you can delete it immediately with <span class="attribute">del ball</span>.</p>
      </div>
      <div> </div>

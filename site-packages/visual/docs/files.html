...
get_file(filter)
      ...
      <p class="Normal">With this filter specification, the first set of files displayed are .py files, and there is a menu that lets you choose one of the other sets of files. The asterisk (*) is a &quot;wild card&quot; standing for &quot;any text&quot;.</p>

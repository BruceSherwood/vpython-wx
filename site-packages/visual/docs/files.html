...
from visual.filedialog import save_file<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;fd.close() # close the file (we're through with it)<br />
      ...
      <p class="program">filter = &quot;Python source (*.py)|*.py&quot;     \<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;Compiled Python (*.pyc)|*.pyc&quot; \<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;Text files (*.txt)|*.txt&quot;        \<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;All files (*.*)|*.*&quot;<br />
<br />
get_file(filter)
      </p>
      <p class="Normal">With this filter specification, the first set of files displayed are .py files, and there is a menu that lets you choose one of the other sets of files. The asterisk (*) is a &quot;wild card&quot; standing for &quot;any text&quot;. (The filter option does not work on some versions of Linux.)</p>

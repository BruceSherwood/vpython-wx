...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      <table width="100%" border="1">
        <tr>
          <td width="44%" height="213"><div align="center"><span class="style1 style2"><font color="#0000A0">Reading
      ...
      <div></div>
      <div>
        <p class="Normal">A  file dialog package is provided in the module
        ...
        <p class="Normal">Here is how to get a file dialog display to choose
          ...
          ('\n').</p>
      <p class="program">from visual import * # must import visual or vis first<br />
        from visual.filedialog import get_file<br />
  fd = get_file()<br />
  if fd:<br />
...
&nbsp;&nbsp;&nbsp;&nbsp;fd.close() # close the file (we're through with it)<br />
    &nbsp;&nbsp;&nbsp;&nbsp;print(data)<br />
      ...
      <p class="Normal">To choose a file and write data to the chosen file, do
        this:</p>
      <p class="program">from visual import * # must import visual or vis first<br />
from visual.filedialog import save_file<br />
        fd = save_file()<br />
          if fd:<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;fd.close() # close the file (we're through with it)<br />
      ...
      <p class="Normal">The examples shown above are sufficient for many tasks,
          but you can customize the file dialog display by specifying what kinds of files will be displayed in the file dialogs like this:</p>
      <p class="program">filter = &quot;Python source|*.py&quot;<br />
        get_file(filter)</p>
      <p class="Normal">With this filter specification, the only files displayed are .py files. The asterisk (*) is a &quot;wild card&quot; standing for &quot;any text&quot;. (The filter option does not work on some versions of Linux.)</p>
      <p class="Normal">Here are other examples of filter expressions: </p>
      <p class="program">&quot;Text files|*.txt&quot; # show only text files<br />
  &quot;All files|*.*&quot;
        &nbsp;&nbsp;&nbsp;# show all types of files<br />
  &quot;Python  and text|*.py;*.txt&quot; # show both kinds
        of files<br />
  &quot;Python|*.py|Text|*.txt&quot; # choose which kind to list</p>
      <p class="Normal">With the following filter specification, the menu  lets you choose one or the other sets of files:</p>
      <p class="program">&quot;Python|*.py|Text|*.txt&quot; # choose which kind to list</p>
      <p class="Normal">In all of these filter expressions, what you place before the &quot;|&quot; character will be displayed to the user (and if there is more than one, the user can choose). What goes after the &quot;|&quot; character is a list separated by semicolons of the file types to be displayed.</p>

...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <div>
        <p class="Normal"> <img src="ring.gif" alt="ring" width="153" height="247" align="right" /> The ring object 
          is circular, with a specified  radius and thickness and with its center 
          given by the <span class="attribute">pos</span> attribute:</p>
        <div>
          <p class="program"> ring(pos=(1,1,1), axis=(0,1,0), radius=0.5, thickness=0.1)</p>
          <p class="Normal"> The ring object has the following attributes and
            default  values, like those for cylinders: <span class="attribute">pos<font color="#000000"> (0,0,0)</font></span>, <span class="attribute">x</span><span class="attribute"><font color="#000000"> (0)</font></span>, <span class="attribute">y<font color="#000000">(0)</font></span>, <span class="attribute">z<font color="#000000">(0)</font></span>, <span class="attribute">axis<font color="#000000"> (1,0,0)</font></span>, <span class="attribute">length<font color="#000000"> (1)</font></span>, <span class="attribute">color<font color="#000000"> (1,1,1)
             which is color.white</font></span>, <span class="attribute">red<font color="#000000"> (1)</font></span>, <span class="attribute">green<font color="#000000"> (1)</font></span>, <span class="attribute">blue<font color="#000000"> (1)</font></span>, <span class="attribute">opacity</span> (1), <a href="materials.html">material</a>, and <span class="attribute">up<font color="#000000"> (0,1,0)</font></span>.
              ...
              effect  on the 3D appearance of a ring unless a non-smooth material
              is specified. The <span class="attribute">axis</span> attribute

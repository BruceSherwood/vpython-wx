...
materials.unshaded (unaffected by lighting)</p>
      ...
      <p class="program">materials.shiny<br />
        ...
        materials.blazed<br />
        materials.silver<br />
        materials.BlueMarble (earth with clouds)<br />
        materials.bricks<br />
        </p>
      ...
      <p class="Normal">Materials will work with graphics cards that support
        ...
        in the VPython package in your site-packages folder. If the graphics hardware
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (1,0,1,0),<br />
    ...
    <p class="Normal">The example above uses a <span class="attribute">rectangular</span> mapping, which places the texture on
          ...
          a beach ball using spherical mapping. Other mapping options are <span class="attribute">cubic</span>, <span class="attribute">cylinder</span>, <span class="attribute">top</span>, <span class="attribute">bottom</span>, <span class="attribute">back</span>, <span class="attribute">front</span>, <span class="attribute">left</span>, and <span class="attribute">right</span>.</p>
...
materials.saveTGA(name,im)</p>
      ...
      <p class="Normal">Normally you create a data pattern containing values in the range from 0.0 to 1.0, the standard range of color components and opacity in VPython. However, the underlying graphics machinery works with values in the range of 0 to 255, which can be expressed in one 8-bit byte of computer memory. If you are dealing with large textures and time is critical, you should avoid conversions from the range 0-1 to the range 0-255 by constructing the texture data from a numpy array of unsigned 8-bit bytes. An unsigned byte is referred to as <strong>ubyte</strong>. Here is a simple example:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;(255,0,255,0) ), ubyte)</p>
      ...
      <p class="Normal">When an object in the scene is small and far away, there is no need to display its texture in full detail. With the default <span class="attribute">mipmap=True</span>, VPython prepares a set of smaller textures to use when appropriate. These additional textures take some time to prepare for later use, and required storage space is one-third larger, but they can speed up the rendering of a scene. It should rarely be the case that you would need to set mipmap=False. </p>

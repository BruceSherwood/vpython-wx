    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      ...
      <div>
        <h3 class="Heading-1"> <font color="#0000A0">I. VPython: the Python/ Visual / 
          ...
          VIDLE environment</font></h3>
        <p class="Normal"> The interactive development environment you will use is called &quot;VIDLE.&quot;</p>
      </div>
      <div>
        ...
        <p class="Normal">If you type or copy the following simple program into the code 
          window in VIDLE and run it (press F5, or use the Run menu), you will see 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        size=(8,4,6),color=color.red)<br />
        ...
        <p class="heading-4">Not all objects in VPython are visible objects. For example, 
          ...
          components one by one; VPython will do the vector addition for you:</p>
      ...
      <h3 class="Heading2"><font color="#0000A0">Warning about division</font></h3>
        <p class="Normal"> If you are using a version of Python prior to Python 3.0, division of integers will not come out the way you may expect, since the result is rounded down to the nearest integer. Thus:</p>
        ...
        are two underscores before the word &quot;future&quot; and two after the word &quot;future&quot;; also, it will display print statements properly on all versions of Python:</p>
          <p class="program"> from __future__ import division, print_function</p>
          <p class="Normal"> This is not necessary for Python versions starting with 3.0, which ignore this statement.</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;rate(30) # limit animation rate, render scene    <br />
      ...
      <p class="Normal"> Infinite loops are ok, because you can always interrupt the program by choosing &quot;Stop Program&quot; from the Run menu in VIDLE.</p>
      ...
      <h3 class="Heading2"><font color="#0000A0">More Information about Python</font></h3>
        <p class="Normal">We have summarized a  small but important subset of the Python programming
          ...
          on the Help menu in VIDLE, and there is additional information at the <a href="http://www.python.org/">Python

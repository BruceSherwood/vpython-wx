...
&nbsp;&nbsp;&nbsp;&nbsp;rate(30) # limit animation rate, render scene    <br />
      ...
      <p class="Normal"> Infinite loops are ok, because you can always interrupt the program by choosing &quot;Stop Program&quot; from the Run menu in IDLE.</p>
        ...
        <p class="program"> print(&quot;It's $%3.2f dollars for %d copies&quot; %
          (price,num))</p>
        <p class="Normal"> For Python versions earlier than Python 3.0, the latter two, rather complicated, print statements will look better without the surrounding parentheses. The surrounding parentheses are required for Python versions starting with Python 3.0</p>

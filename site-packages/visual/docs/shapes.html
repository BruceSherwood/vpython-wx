...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            thickness=0.1)</p></td>
        ...
        <p class="Normal">          creates a circle object at pos=(0,0), with radius=2. There are 64 points used to approximate the circular contour; the default value for the number of points (np) is 32. The circle contour cannot be rounded. A circle can be scaled to obtain a different size circle or an ellipse.         </p>
        <table width="676" border="0">
          <tr>
        ...
        <table width="676" border="0">
          <tr>
            <td width="539" height="133"><p class="Normal">For the circle, the starting angle is by default angle1=0 and the ending angle2 = 2*pi, measured counterclockwise from the +x axis. This partial circle was made by setting angle1=0.15*pi and the ending angle by angle2=pi. You can rotate the shape by specifying rotate to be something other than zero. For a partial circle the thickness is ignored.</p></td>
...
<p class="Normal">For the ellipse, the starting angle is by default angle1=0 and the ending angle by angle2 = 2*pi, measured counterclockwise from the +x axis. A partial ellipse can be made by setting angle1=0.15*pi and angle2=pi. For a partial ellipse the thickness is ignored.</p>
...
<p class="program"><span class="Normal">pl = shapes.pointlist(pos=[(1,0),(1,1),(-2,3),(1,0)], <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  rotate=pi/4)</span></p>
...
<p class="Normal"><span class="attribute">n</span> An integer number defining the number of teeth  of the gear. Normally, &ldquo;tooth size&rdquo; and the number of teeth should define the  gear circumference (or the radius), but in this program the &ldquo;tooth size&rdquo; is not  a control parameter, rather it is calculated by the number of teeth and the  radius. Hence the number of teeth, n, can be set arbitrarily and some  unrealistic values for the &ldquo;tooth size&rdquo; can be obtained in turn. The user  should be setting the parameters appropriately to obtain a reasonable tooth  structure. Default number of teeth is 20.</p>
...
<p class="Normal"><span class="attribute">addendum</span> The &ldquo;tooth depth&rdquo; is defined as the sum of  addendum and dedendum. Addendum is the part of the tooth above the pitch radius  to the tip of the tooth. Default value for addendum is 0.5.</p>

...
<p><select id="menu3" onchange="jumpMenu(this)"></select></p>
    ...
    <td width="586" rowspan="2" valign="top"><!-- InstanceBeginEditable name="content" -->
      <table width="100%" border="1">
        <tr>
          <td width="77%"><div align="center"><span class="style1 style2"><font color="#0000A0">convex</font></span></div></td>
          <td width="23%"><div align="center"><img src="images/convex.jpg" alt="convex" width="130" height="127" /><a href="arrow.html"></a></div></td>
        </tr>
      </table>
      <div></div>
      <div>

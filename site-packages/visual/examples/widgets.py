...
# window.dw and window.dh are the extra width and height of the window
# compared to the display region inside the window. If there is a menu bar,
# there is an additional height taken up, of amount window.mh.
w = window(width=2*(L+window.dw), height=L+window.dh+window.mh,
...
# On Mac and Linux, wx.ALIGN_CENTRE has no effect:
wx.StaticText(p, pos=(d,4), size=(L-2*d,d),
              style=wx.ALIGN_CENTRE, label='A 3D canvas')
...
wx.TextCtrl(p, pos=(1.3*L,70), value='You can type here:\n',

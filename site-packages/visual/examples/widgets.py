...
# compared to the display region inside the window, the difference being
# due to window borders, title bar, and menu bar.
w = window(width=2*(L+window.dw), height=L+window.dh+window.mh, title='Widgets')
